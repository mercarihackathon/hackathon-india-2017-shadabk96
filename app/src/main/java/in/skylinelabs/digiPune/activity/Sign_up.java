...
public class Sign_up extends Activity implements LocationListener {
    ...
    private static final String url_create_product = "http://shadabk96.000webhost.com/Geo/signup_app.php";
    private static final String url_product_exists = "http://shadabk96.000webhost.com/Geo/get_product_exists.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // launch login instead of signup
                       ...
                       if (j) {
                           try {
                               ...
                               if (success == 0) {
                                   ...
                                   params.add(new BasicNameValuePair("gcm_regid", "1234")); // sk02 regid -> "1234"
